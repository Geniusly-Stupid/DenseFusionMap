...
if __name__ == "__main__":
    ...
    parser.add_argument("--poses_file", default=r"D:\Desktop\EECS568\Project\DenseFusionMap\data\slam\poses.txt", help="pose path file in KITTI format")
    parser.add_argument(
        "--timestamp_file", default=r"D:\Desktop\EECS568\Project\DenseFusionMap\data\slam\times.txt", help="KITTI timestamp file of the poses")
    parser.add_argument(
        "--trajectory_out", default=r"D:\Desktop\EECS568\Project\DenseFusionMap\data\slam\groundtruth.txt", help="output file path for trajectory in TUM format")
